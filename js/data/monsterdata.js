	...
	self.initAtlas = function(){
		...
		self.soliderhero_atlas = new Hilo.TextureAtlas({
				...
				frames: [
					...
					[1134, 310, 217, 310],
					[1134, 0, 217, 310],
					[1085, 620, 217, 310], //walk 0-5
					
					[1785, 0, 217, 310],  //squat 6
					
					[700, 310, 217, 310],  
					[868, 620, 217, 310],  //idle 7-8
					
					[1736,620,217,310],//jump 9
					
					[1568,0,217,310], //arm 10
					
					[1568,310,217,310],//arm up 11
					...
					[700,0,217,310],
					[917,0,217,310],
					[917,310,217,310], //run  19-24
					
					[1785,310,217,310], //runstop  25
