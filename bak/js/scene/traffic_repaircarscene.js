(function(ns) {
	var Trafficrepaircarscene = ns.Trafficrepaircarscene = Hilo.Class.create({
		...
		constructor: function(properties) {
			Trafficrepaircarscene.superclass.constructor.call(this, properties);
